...
class TestSequenceTagger:
    ...
    def test_log_probability_return_result_without_error_if_sentences_have_been_predicted(
        ...
        """Test SequenceTagger.log_probability run succefully if sentence have been predicted"""
        # Act
    ...
    def test_log_probability_raise_index_error_if_unlabeled_sentences_have_not_been_predicted(
        ...
        """Test SequenceTagger.log_probability raise error if unlabeled sentences have not been predicted"""
        # Assert
    ...
    def test_log_probability_raise_error_if_labeled_sentences_have_not_been_predicted(
        ...
        """Test SequenceTagger.log_probability raise error if labeled sentences have not been predicted"""
        # Arrange
